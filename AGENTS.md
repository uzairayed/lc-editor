...
Two shots in one frame: `layout_add` (`specs/layouts.md`). Occasional pair → `context/scenes/pair.md`. Collage / mostly stacks / caption-must → `context/scenes/collage.md`. Two highway or helmet POVs → `context/scenes/ride-pair.md`.
